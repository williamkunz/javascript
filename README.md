# Containership JavaScript Style Guide
> Forked and modified from AirBnB's great [style guide](https://github.com/airbnb/javascript)
...
```
  ...
  <a name="objects--grouped-alphabetically"></a><a name="3.7"></a>
  - [3.5](#objects--grouped-alphabetically) Group your properties alphabetically at your object declaration.
...
- [21.1](#semicolons--required) **Nope.** eslint: [`semi`](http://eslint.org/docs/rules/semi.html) jscs: [`requireSemicolons`](http://jscs.info/rule/requireSemicolons)
